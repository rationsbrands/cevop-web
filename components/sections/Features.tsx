...
import { IconQR, IconMonitor, IconBell, IconBranch, IconWhatsApp, IconUsers, IconOffline, IconDownload } from '@/components/icons'
...
const features = [
  ...
  { Icon: IconWhatsApp, name: 'WhatsApp Notifications', desc: 'New orders and waiter calls sent directly to your WhatsApp.' },
