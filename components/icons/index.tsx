...
export const LogoMark = ({ size = 24, className = '' }: LogoProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 64 64"
  ...
  >
    <path
      d="M41.5 18.5c-4.7-4.7-11.7-6.7-18-4.9-8.2 2.4-13.9 10.2-13.9 18.4s5.7 16 13.9 18.4c6.3 1.8 13.3-.2 18-4.9"
      stroke="currentColor"
      strokeWidth="8"
      strokeLinecap="round"
      strokeLinejoin="round"
